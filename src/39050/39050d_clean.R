...
save_clean_csv(data39050d, csv_suffix = 6, vol = 3)
...
meta39050d <- annotate(data = data39050d,
                       ...
                       csv_suffix = 6,
                       vol = 3,
                       title = "Einnahmen der Stadt Basel: Steuern und Renten ab 1424",
                       ...
                       relation = list("m39050_1", "m39050_2", "m39050_3", "m39050_4", "m39050_5")
                       )