...
colnames(data80380) <- c(
  "Tageszeitungen (total verkaufte Auflage Print, exkl. Gratisauflage)",
  1966,
  1972,
  1978,
  1984,
...
meta80380 <- annotate(
  ...
  column_description = c(
    "Name der jeweiligen Tageszeitung", "Total verkaufte Auflage der jeweiligen Zeitung im entsprechenden Jahr. Angaben für die Printausgabe, exkl. Gratisauflage",
