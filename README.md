...
- [ ] search and replace `Moritz Twente`, `mtwente`, `sgb-figures`, `code and data for creating plots used in Stadt.Geschichte.Basel` `[mtwente@protonmail.com]` in [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md), [package.json](package.json), [README.template.md](README.template.md), [SECURITY.md](SECURITY.md)
