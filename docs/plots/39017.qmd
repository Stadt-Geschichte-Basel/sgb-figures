...
df <- data.frame(
  ...
  Value = c(
    "[abb39017](https://forschung.stadtgeschichtebasel.ch/items/abb39017.html)",
    ...
    "Stadt.Geschichte.Basel: Rentengeschäft von Ludwig Kilchmann. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb39017.html#m39017_3>, letzte Aktualisierung: 26.09.2025.",
    "2025-09-26 21:43:22"
  ),
