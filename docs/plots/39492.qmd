...
df <- data.frame(
  ...
  Value = c(
    ...
    "Stadt.Geschichte.Basel: Bürgeraufnahmen und Kriegsausgaben, 1360–1530. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb39492.html#m39492_3>, letzte Aktualisierung: 27.09.2025.",
    "Public Domain Mark",
...
knitr::kable(df, format = "markdown", caption = "Dataset Overview (39492_3)")
```
