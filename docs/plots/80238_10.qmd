...
df <- data.frame(
  ...
  Value = c(
    ...
    "Stadt.Geschichte.Basel: Vertretung Basel-Stadt im Ständerat, 1963–2023. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb80238.html#m80238_12>, letzte Aktualisierung: 30.09.2025.",
    "Public Domain Mark",
...
caption = "Selected Metadata for Dataset 80238_12")
```
