...
vol_short: "Burkart, Lucas (Hg.): Stadt in Verhandlung. 1250–1530. Basel 2024 (Stadt.Geschichte.Basel 3)."
plotid: "abb39050_1"
format:
  html:
    fig-width: 8
...
df <- data.frame(
  ...
  Value = c(
    "[abb39050](https://forschung.stadtgeschichtebasel.ch/items/abb39050.html)",
...
df <- data.frame(
  ...
  Value = c(
    ...
    "Stadt.Geschichte.Basel: Einnahmen der Stadt Basel: Ungelder und Zölle ab 1424. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb39050.html#m39050_3>, letzte Aktualisierung: 27.09.2025.",
    "2025-09-27 01:01:22"
  ),
  stringsAsFactors = FALSE
)
