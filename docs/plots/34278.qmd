...
df <- data.frame(
  ...
  Value = c(
    "[abb34278](https://forschung.stadtgeschichtebasel.ch/items/abb34278.html)",
    ...
    "Stadt.Geschichte.Basel: Schema der Dreifelderwirtschaft. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb34278.html#m34278_3>, letzte Aktualisierung: 26.09.2025.",
    "2025-09-26 21:43:22"
  ),
