...
df <- data.frame(
  ...
  Value = c(
    ...
    "Stadt.Geschichte.Basel: Schema der Dreifelderwirtschaft. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb34278.html#m34278_3>, letzte Aktualisierung: 27.09.2025.",
    "Public Domain Mark",
...
knitr::kable(df, format = "markdown", caption = "Dataset Overview (34278_3)")
```
