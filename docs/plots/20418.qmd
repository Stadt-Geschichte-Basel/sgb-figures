...
df <- data.frame(
  ...
  Value = c(
    ...
    "Stadt.Geschichte.Basel: Exportabgaben und Konsumsteuern, 1690–1798. Forschungsdatenplattform Stadt.Geschichte.Basel, <https://forschung.stadtgeschichtebasel.ch/items/abb20418.html#m20418_3>, letzte Aktualisierung: 28.09.2025.",
    "CC BY-SA 4.0",
...
knitr::kable(df, format = "markdown", caption = "Dataset Overview (20418_3)")
```
