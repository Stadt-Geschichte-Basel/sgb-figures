...
The content of this page is a translated assemblage of selected content on Stadt.Geschichte.Basel's corporate identity, colour palettes and overall design philosophy. Only the colour palette for print products -- since it is used in sgb-figures -- is covered here. Refer to the [RDM Documentation](https://dokumentation.stadtgeschichtebasel.ch) for full coverage of Stadt.Geschichte.Basel's design and corporate identity guidelines (in German).
:::
